-- bash's help texts (generated from bash 5.2 `help`; the oracle the conformance suite runs).
-- topics in bash's table order: { name, short synopsis, long description lines }
return {
	{ "%", "job_spec [&]", {
