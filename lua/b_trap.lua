...
local I = M._int
local block_sig, canon_sig, sig_order = I.block_sig, I.canon_sig, I.sig_order
local SIGNUM, NUMSIG = I.SIGNUM, I.NUMSIG
local C = I.C
			...
			for k = sigstart, #args do
				...
				elseif sh.sig_ign_start and sh.sig_ign_start[canon] then
					...
					if canon == "ERR" then -- (it fires where it was set: see interp's fire_err_trap)
						...
						sh.err_trap_ps = sh.in_pipestage or 0 -- (and a stage fires one set in it)
