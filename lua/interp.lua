...
local function exec_simple(sh, args, hook, no_func)
  ...
  if lz then return require(lz)(sh, cmd, args, hook, tcb) end
...
M._int = {
  ...
  job_reap = job_reap, block_sig = block_sig, canon_sig = canon_sig, sig_order = sig_order,
  find_all_in_path = find_all_in_path, name_type = name_type, SIGNUM = SIGNUM, NUMSIG = NUMSIG,
  array_key = array_key, arith_resolve = arith_resolve, arith_nounset = arith_nounset,
  sh_printf = sh_printf, fd_getc = fd_getc, fd_ready = fd_ready, read_split = read_split,
